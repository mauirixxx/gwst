...
<section class="treasure-page">
    <div class="treasure-heading">
        ...
        <?php if ($characterValid): ?>
            ...
            <div class="treasure-heading-actions">
                <a class="treasure-button treasure-button-secondary" href="treasure-history.php">View collection history</a>
                <a class="treasure-button treasure-button-secondary" href="treasure-overview.php">All-character overview</a>
            </div>
        <?php else: ?>
            <p>Select an account and character in the header to view treasure availability.</p>
            <p class="treasure-heading-actions"><a class="treasure-button treasure-button-secondary" href="treasure-overview.php">All-character overview</a></p>
        <?php endif; ?>
    </div>
